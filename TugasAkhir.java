...
public class TugasAkhir {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("\nRalph: How should I call you, friend?\n> ");
        name = sc.nextLine();
        System.out.printf("\nRalph: Nice to meet you %s.\n", name);
        System.out.println("\nRalph: So in the scale of 1 to 10, how excited are you \nto buy PC parts from our store ?");
        ...
        do{
            ...
            if(soldOut || !ansStr.contains("y") && !ansStr.contains("Y")){
                ...
                System.out.println("\nRalph: There is 10% tax, and there is 5% discount if you \npay with credit card.");
        ...
        System.out.printf("\nRalph: Goodbye and have a nice day, %s.\n", name);
